...
class KerusakanBeratScreen extends StatefulWidget {
  const KerusakanBeratScreen({super.key});

  @override
  State<KerusakanBeratScreen> createState() => _KerusakanBeratScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Data Kerusakan Berat', style: TextStyle(fontSize: 16)),
        centerTitle: true,
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemCount: daftarRusakBerat.length,
            itemBuilder: (context, index) {
              final doc = daftarRusakBerat[index];
              final data = doc.data() as Map<String, dynamic>;
