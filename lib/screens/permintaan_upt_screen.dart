...
class _PermintaanUptScreenState extends State<PermintaanUptScreen> {
  ...
  // Fungsi untuk memperbarui status permintaan (Setujui / Tolak)
  Future<void> _updateStatusPermintaan(String docId, String statusBaru, String namaBarangDiminta, int jumlahDiminta) async {
    try {
      ...
      // 2. Update status pada laporan/permintaan
      await FirebaseFirestore.instance
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Mengambil data secara real-time dari Firestore khusus yang statusnya 'Menunggu'
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Catatan: Jika ingin difilter HANYA untuk UPT (seperti di halaman POS), 
          // Anda bisa menambahkan filter lokal di sini. Sementara ini mengambil semua data sesuai kode asli Anda.
          final daftarPermintaanUPT = snapshot.data!.docs;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Tampilkan gambar jika ada lampiran foto
